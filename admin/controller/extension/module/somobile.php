...
class ControllerExtensionModuleSoMobile extends Controller {
    ...
    public function index() {
		...
		$data['listmenus'] =  isset($module_info['mobile_general']['listmenus']) ? $this->sortArray($module_info['mobile_general']['listmenus'],'sort') : array();
		$data['footermenus'] = isset($module_info['mobile_general']['footermenus']) ? $this->sortArray($module_info['mobile_general']['footermenus'],'sort') : array();
