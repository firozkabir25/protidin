...
/* so-mobile/template/extension/module/so_page_builder/default.twig */
class __TwigTemplate_ddafad4cfc0f608ef1ef91cdbcc90d9406daa7c6574f0485744fa13604c394c3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["col"], "rows", [], "any", false, false, false, 29) && twig_get_attribute($this->env, $this->source, $context["col"], "rows", [], "any", false, false, false, 29))) {
                    ...
                    // line 31
                    echo "\t\t\t\t\t\t\t\t";
                    $this->loadTemplate((($context["DIR_TEMPLATE"] ?? null) . ($context["template_row"] ?? null)), "so-mobile/template/extension/module/so_page_builder/default.twig", 31)->display($context);
                    // line 32
                    echo "\t\t\t\t\t\t\t";
                }
                // line 33
...
\t\t";
    ...
    {
        return "so-mobile/template/extension/module/so_page_builder/default.twig";
    }
    ...
    {
        return new Source("", "so-mobile/template/extension/module/so_page_builder/default.twig", "/home/azhkhn/public_html/protidin.com.bd/catalog/view/theme/so-mobile/template/extension/module/so_page_builder/default.twig");
    }
}
