...
class __TwigTemplate_806b0ce1fbc7242839417dd094eff9a6d1124330a7a2ecbb88ac75a83e98e3cf extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["col"], "rows", [], "any", false, false, false, 29) && twig_get_attribute($this->env, $this->source, $context["col"], "rows", [], "any", false, false, false, 29))) {
                    ...
                    // line 31
                    echo "\t\t\t\t\t\t\t\t";
                    $this->loadTemplate((($context["DIR_TEMPLATE"] ?? null) . ($context["template_row"] ?? null)), "so-buyshop/template/extension/module/so_page_builder/default.twig", 31)->display($context);
                    // line 32
                    echo "\t\t\t\t\t\t\t";
                }
                // line 33
...
\t\t";
    ...
    {
        return new Source("", "so-buyshop/template/extension/module/so_page_builder/default.twig", "/home/azhkhn/public_html/protidin.com.bd/catalog/view/theme/so-buyshop/template/extension/module/so_page_builder/default.twig");
    }
}
